      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-6">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="flex flex-grow">
            <ul className="flex flex-grow justify-end flex-wrap items-center mt-4">
              {/* <li>
                <Link to="/signin" className="translate hover:scale-110  font-bold text-gray-600 hover:text-gray-900 px-5 py-3 flex items-center transition duration-150 ease-in-out">Who We Are</Link>
              </li>
              <li>
